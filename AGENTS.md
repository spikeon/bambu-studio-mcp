...
## Cursor plugin (skill distribution)

| Path | Role |
|------|------|
| `plugins/bambu-prefixed-stl-extract/` | Cursor **plugin** bundle: `.cursor-plugin/plugin.json`, `skills/bambu-prefixed-stl-extract/SKILL.md`, `mcp.json`. This is what you ship for Marketplace / team marketplace—not a loose file under `.cursor/skills/`. |
